...
#include "ocs2_msgs/msg/detail/mpc_observation__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ocs2_msgs::msg::MpcObservation;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ocs2_msgs::msg::MpcObservation *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ocs2_msgs::msg::MpcObservation *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _MpcObservation__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const ocs2_msgs::msg::MpcObservation *>(
...
static size_t _MpcObservation__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_MpcObservation(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _MpcObservation__callbacks = {
  "ocs2_msgs::msg",
  "MpcObservation",
...
static rosidl_message_type_support_t _MpcObservation__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_MpcObservation__callbacks,
...
{
  return &ocs2_msgs::msg::typesupport_fastrtps_cpp::_MpcObservation__handle;
}
