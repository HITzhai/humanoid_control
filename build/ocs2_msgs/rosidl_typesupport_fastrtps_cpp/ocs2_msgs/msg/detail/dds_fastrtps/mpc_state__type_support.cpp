...
#include "ocs2_msgs/msg/detail/mpc_state__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ocs2_msgs::msg::MpcState;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ocs2_msgs::msg::MpcState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ocs2_msgs::msg::MpcState *>(
    untyped_ros_message);
...
{
  return &ocs2_msgs::msg::typesupport_fastrtps_cpp::_MpcState__handle;
}
