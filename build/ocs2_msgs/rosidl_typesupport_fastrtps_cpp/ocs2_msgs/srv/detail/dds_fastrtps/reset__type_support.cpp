...
#include "ocs2_msgs/srv/detail/reset__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  ocs2_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.target_trajectories,
    cdr);
  return true;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ocs2_msgs::srv::Reset_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ocs2_msgs::srv::Reset_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ocs2_msgs::srv::Reset_Request *>(
    untyped_ros_message);
...
{
  return &ocs2_msgs::srv::typesupport_fastrtps_cpp::_Reset_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = ocs2_msgs::srv::Reset_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ocs2_msgs::srv::Reset_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<ocs2_msgs::srv::Reset_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &ocs2_msgs::srv::typesupport_fastrtps_cpp::_Reset_Response__handle;
}
...
{
  return &ocs2_msgs::srv::typesupport_fastrtps_cpp::_Reset__handle;
}
