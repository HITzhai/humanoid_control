...
static const _ControllerData_type_support_symbol_names_t _ControllerData_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ocs2_msgs, msg, ControllerData)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ocs2_msgs, msg, ControllerData)),
  }
};
...
{
  return &::ocs2_msgs::msg::rosidl_typesupport_cpp::ControllerData_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, ocs2_msgs, msg, ControllerData)() {
  return get_message_type_support_handle<ocs2_msgs::msg::ControllerData>();
}
