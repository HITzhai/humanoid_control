...
static const _MpcTargetTrajectories_type_support_symbol_names_t _MpcTargetTrajectories_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ocs2_msgs, msg, MpcTargetTrajectories)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ocs2_msgs, msg, MpcTargetTrajectories)),
  }
};
...
{
  return &::ocs2_msgs::msg::rosidl_typesupport_cpp::MpcTargetTrajectories_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, ocs2_msgs, msg, MpcTargetTrajectories)() {
  return get_message_type_support_handle<ocs2_msgs::msg::MpcTargetTrajectories>();
}
