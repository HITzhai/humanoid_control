...
static const _Multiplier_type_support_symbol_names_t _Multiplier_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ocs2_msgs, msg, Multiplier)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ocs2_msgs, msg, Multiplier)),
  }
};
...
{
  return &::ocs2_msgs::msg::rosidl_typesupport_cpp::Multiplier_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, ocs2_msgs, msg, Multiplier)() {
  return get_message_type_support_handle<ocs2_msgs::msg::Multiplier>();
}
