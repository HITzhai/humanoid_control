...
#include "ocs2_msgs/msg/detail/controller_data__rosidl_typesupport_fastrtps_c.h"
...
using _ControllerData__ros_msg_type = ocs2_msgs__msg__ControllerData;
...
static uint32_t _ControllerData__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ocs2_msgs__msg__ControllerData(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ocs2_msgs__msg__ControllerData;
    is_plain =
      (
...
static size_t _ControllerData__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ocs2_msgs__msg__ControllerData(
