...
#include "ocs2_msgs/msg/detail/mpc_state__rosidl_typesupport_fastrtps_c.h"
...
using _MpcState__ros_msg_type = ocs2_msgs__msg__MpcState;
...
static uint32_t _MpcState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ocs2_msgs__msg__MpcState(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ocs2_msgs__msg__MpcState;
    is_plain =
      (
...
static size_t _MpcState__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ocs2_msgs__msg__MpcState(
